                                ...
                                <div class="content">
                                    <h1 class="heading">
                                        ...
                                        <span class="heading-sm">
                                            <span class="sup">CORONAVIRUS</span>
                    ...
                    <div class="section-content">
                        <div class="row g-gs justify-content-center">
                            <div class="col-sm-10 col-md-8 col-lg-4">
                                <div class="box">
                                    <div class="box-gfx">
                                        <img src="../assets/images/gfx/spread-a.png" alt="">
                                    </div>
                            ...
                            <div class="col-sm-10 col-md-8 col-lg-4">
                                <div class="box">
                                    <div class="box-gfx">
                                        <img src="../assets/images/gfx/spread-b.png" alt="">
                                    </div>
                                    <div class="box-content">
                            ...
                            <div class="col-sm-10 col-md-8 col-lg-4">
                                <div class="box">
                                    <div class="box-gfx">
                                        <img src="../assets/images/gfx/spread-c.png" alt="">
                                    </div>
                                    <div class="box-content">
                    ...
                    <div class="section-content">
                        <div class="row g-gs justify-content-center">
                            <div class="col-sm-10 col-md-8 col-lg-4">
                                <div class="box2">
                                    <div class="box2-gfx">
                                        <img src="../assets/images/gfx/symptom-a.png" alt="">
                                    </div>
                            ...
                            <div class="col-sm-10 col-md-8 col-lg-4">
                                <div class="box2">
                                    <div class="box2-gfx">
                                        <img src="../assets/images/gfx/symptom-b.png" alt="">
                                    </div>
                                    <div class="box2-content">
                            ...
                            <div class="col-sm-10 col-md-8 col-lg-4">
                                <div class="box2">
                                    <div class="box2-gfx">
                                        <img src="../assets/images/gfx/symptom-c.png" alt="">
                                    </div>
                                    <div class="box2-content">
                ...
                <div class="container">
                    <div class="section-content section-content-boxed">
                        <div class="row g-gs justify-content-center align-items-center">
                            ...
                            <div class=" col-sm-10 col-md-8 col-lg-4">
                                <img src="../assets/images/gfx/steps.png" class="mb-2 mb-sm-0" alt="">
                            </div><!-- .col -->
                        </div><!-- .row -->
                    </div><!-- .section-content -->
                </div><!-- .container -->
                    ...
                    <div class="section-content">
                        <div class="row g-gs justify-content-center">
                            <div class="col-6 col-mb-5 col-sm-4 col-lg-2">
                                <div class="box4">
                                    <div class="box4-gfx">
                                        <img src="../assets/images/gfx/hand-a.png" alt="">
                                    </div>
                            ...
                            <div class="col-6 col-mb-5 col-sm-4 col-lg-2">
                                <div class="box4">
                                    <div class="box4-gfx">
                                        <img src="../assets/images/gfx/hand-b.png" alt="">
                                    </div>
                                    <div class="box4-content">
                            ...
                            <div class="col-6 col-mb-5 col-sm-4 col-lg-2">
                                <div class="box4">
                                    <div class="box4-gfx">
                                        <img src="../assets/images/gfx/hand-c.png" alt="">
                                    </div>
                                    <div class="box4-content">
                            ...
                            <div class="col-6 col-mb-5 col-sm-4 col-lg-2">
                                <div class="box4">
                                    <div class="box4-gfx">
                                        <img src="../assets/images/gfx/hand-d.png" alt="">
                                    </div>
                                    <div class="box4-content">
                            ...
                            <div class="col-6 col-mb-5 col-sm-4 col-lg-2">
                                <div class="box4">
                                    <div class="box4-gfx">
                                        <img src="../assets/images/gfx/hand-e.png" alt="">
                                    </div>
                                    <div class="box4-content">
                            ...
                            <div class="col-6 col-mb-5 col-sm-4 col-lg-2">
                                <div class="box4">
                                    <div class="box4-gfx">
                                        <img src="../assets/images/gfx/hand-f.png" alt="">
                                    </div>
                                    <div class="box4-content">
                        ...
                        <div class="row g-gs justify-content-center flex-lg-nowrap">
                            <div class="col-md-8 col-lg-5 col-xl-6 align-self-end">
                                <div class="protect-block-gfx">
                                    <img src="../assets/images/gfx/protect.png" alt="">
                                </div>
                            </div><!-- .col -->
                            <div class="col-6 col-mb-5 col-sm-6 col-lg-4 col-xl-3 flex-grow-1 order-lg-first">
                                <div class="protect-item negative">
                                    <div class="protect-gfx">
                                        <img src="../assets/images/gfx/donts-a.png" alt="">
                                    </div>
                                ...
                                <div class="protect-item negative">
                                    <div class="protect-gfx">
                                        <img src="../assets/images/gfx/donts-b.png" alt="">
                                    </div>
                                    <div class="protect-text">
                                ...
                                <div class="protect-item negative">
                                    <div class="protect-gfx">
                                        <img src="../assets/images/gfx/donts-c.png" alt="">
                                    </div>
                                    <div class="protect-text">
                            ...
                            <div class="col-6 col-mb-5 col-sm-6 col-lg-4 col-xl-3 flex-grow-1 test">
                                <div class="protect-item positive">
                                    <div class="protect-gfx">
                                        <img src="../assets/images/gfx/dos-a.png" alt="">
                                    </div>
                                    <div class="protect-text">
                                ...
                                <div class="protect-item positive">
                                    <div class="protect-gfx">
                                        <img src="../assets/images/gfx/dos-b.png" alt="">
                                    </div>
                                    <div class="protect-text">
                                ...
                                <div class="protect-item positive">
                                    <div class="protect-gfx">
                                        <img src="../assets/images/gfx/dos-c.png" alt="">
                                    </div>
                                    <div class="protect-text">
                                            ...
                                            <div class="accordion-item">
                                                ...
                                                <div id="covid-spreads-05" class="collapse">
                                                    <div class="accordion-content">
                                                        ...
                                                        <p>Learn what is known about the <a href="https://www.cdc.gov/coronavirus/2019-ncov/prepare/transmission.html" target="_blank">spread of COVID-19</a>.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="accordion-item">
                    ...
                    <div class="section-content">
                        <div class="row g-gs justify-content-center">
                            <div class="col-md-9 col-lg-4">
                                <div class="blog-item">
                                    <div class="blog-image">
                                        <img src="../assets/images/blog/blog-a.jpg" alt="">
                                    </div>
                                    <div class="blog-text">
                            ...
                            <div class="col-md-9 col-lg-4">
                                <div class="blog-item">
                                    <div class="blog-image">
                                        <img src="../assets/images/blog/blog-b.jpg" alt="">
                                    </div>
                                    <div class="blog-text">
                            ...
                            <div class="col-md-9 col-lg-4">
                                <div class="blog-item">
                                    <div class="blog-image">
                                        <img src="../assets/images/blog/blog-c.jpg" alt="">
                                    </div>
                                    <div class="blog-text">
                                        <h5 class="title"><a href="#">If You Think You Are Sick</a></h5>
                                        <p>If you are sick with COVID-19 or think you might have it, follow the steps below to help protect other people in your home and community</p>
                                    </div>
                                </div><!-- .blog-item -->
                            </div><!-- .col -->
                        </div><!-- .row -->
